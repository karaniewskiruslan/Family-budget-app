...
const CalculationDateButton = () => {
  ...
  return (
    <button
      ...
      className="absolute right-8 top-6 size-10 rounded-full bg-transparent p-2 outline outline-2 -outline-offset-1 outline-gray-400 hover:cursor-pointer dark:outline-gray-600"
    >
