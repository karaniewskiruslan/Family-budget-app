...
const DateButton = ({
  ...
  const buttonStyle = closeButton
    ? "absolute right-2 top-2 size-6 rounded-full p-[0.125rem] text-xs outline outline-2 -outline-offset-1 outline-gray-400 dark:outline-gray-600 bg-transparent grid place-items-center"
